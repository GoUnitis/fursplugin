...
public class CanonicalizationMethodType implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":CanonicalizationMethodType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "CanonicalizationMethodType", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CanonicalizationMethodType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CanonicalizationMethodType object = new CanonicalizationMethodType();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CanonicalizationMethodType".equals(type)) {
                            ...
                            return (CanonicalizationMethodType) si.gov.fu.www.v1.cash_registers.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
