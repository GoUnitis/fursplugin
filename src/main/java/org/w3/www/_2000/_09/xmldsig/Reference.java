...
public class Reference implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
         ...
         */
        public static Reference parse(javax.xml.stream.XMLStreamReader reader)
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                            ...
                            object.setReference(org.w3.www._2000._09.xmldsig.ReferenceType.Factory.parse(
                                    reader));
