...
public class KeyValue implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
         ...
         */
        public static KeyValue parse(javax.xml.stream.XMLStreamReader reader)
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    ...
                                    "KeyValue").equals(reader.getName())) {
