...
public class ManifestType implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ManifestType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ManifestType", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ManifestType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ManifestType object = new ManifestType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ManifestType".equals(type)) {
                            ...
                            return (ManifestType) si.gov.fu.www.v1.cash_registers.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    list1.add(org.w3.www._2000._09.xmldsig.ReferenceType.Factory.parse(
                            reader));
