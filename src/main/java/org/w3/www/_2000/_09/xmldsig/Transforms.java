...
public class Transforms implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
         ...
         */
        public static Transforms parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Transforms object = new Transforms();
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    ...
                                    "Transforms").equals(reader.getName())) {
