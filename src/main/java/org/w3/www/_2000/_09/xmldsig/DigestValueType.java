...
public class DigestValueType implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DigestValueType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DigestValueType", xmlWriter);
            }
        }

        if (localDigestValueType == null) {
            throw new org.apache.axis2.databinding.ADBException(
                "DigestValueType cannot be null !!");
        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localDigestValueType));
        }
    ...
    public static class Factory {
        public static DigestValueType fromString(java.lang.String value,
            ...
            returnValue.setDigestValueType(org.apache.axis2.databinding.utils.ConverterUtil.convertToBase64Binary(
                    value));

            return returnValue;
        }

        public static DigestValueType fromString(
         ...
         */
        public static DigestValueType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DigestValueType object = new DigestValueType();
                    ...
                    if (reader.isStartElement() || reader.hasText()) {
                        if (reader.isStartElement() || reader.hasText()) {
                            ...
                            if ("true".equals(nillableValue) ||
                                ...
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "DigestValueType" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setDigestValueType(org.apache.axis2.databinding.utils.ConverterUtil.convertToBase64Binary(
                                    content));
