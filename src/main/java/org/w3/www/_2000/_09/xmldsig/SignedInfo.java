...
public class SignedInfo implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
         ...
         */
        public static SignedInfo parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            SignedInfo object = new SignedInfo();
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    ...
                                    "SignedInfo").equals(reader.getName())) {
