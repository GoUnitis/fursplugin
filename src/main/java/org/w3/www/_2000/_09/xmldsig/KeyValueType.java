...
public class KeyValueType implements org.apache.axis2.databinding.ADBBean {
    /**
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":KeyValueType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "KeyValueType", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static KeyValueType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            KeyValueType object = new KeyValueType();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"KeyValueType".equals(type)) {
                            ...
                            return (KeyValueType) si.gov.fu.www.v1.cash_registers.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "http://www.w3.org/2000/09/xmldsig#",
                                    "DSAKeyValue").equals(reader.getName())) {
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "http://www.w3.org/2000/09/xmldsig#",
                                    "RSAKeyValue").equals(reader.getName())) {
