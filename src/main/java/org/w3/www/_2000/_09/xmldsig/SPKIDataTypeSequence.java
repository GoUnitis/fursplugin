...
public class SPKIDataTypeSequence implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":SPKIDataTypeSequence", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "SPKIDataTypeSequence", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SPKIDataTypeSequence parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SPKIDataTypeSequence object = new SPKIDataTypeSequence();
