...
public class SPKIData implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
         ...
         */
        public static SPKIData parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            SPKIData object = new SPKIData();
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    ...
                                    "SPKIData").equals(reader.getName())) {
