...
public class RetrievalMethodType implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":RetrievalMethodType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "RetrievalMethodType", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RetrievalMethodType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RetrievalMethodType object = new RetrievalMethodType();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RetrievalMethodType".equals(type)) {
                            ...
                            return (RetrievalMethodType) si.gov.fu.www.v1.cash_registers.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
