...
public class DigestMethodType implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DigestMethodType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DigestMethodType", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DigestMethodType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DigestMethodType object = new DigestMethodType();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DigestMethodType".equals(type)) {
                            ...
                            return (DigestMethodType) si.gov.fu.www.v1.cash_registers.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
