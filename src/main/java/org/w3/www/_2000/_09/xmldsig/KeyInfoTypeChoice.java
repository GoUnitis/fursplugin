...
public class KeyInfoTypeChoice implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for KeyName
     */
    ...
    public void setRetrievalMethod(
        org.w3.www._2000._09.xmldsig.RetrievalMethodType param) {
        clearAllSettingTrackers();
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":KeyInfoTypeChoice", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "KeyInfoTypeChoice", xmlWriter);
            }
        }
        ...
        if (localKeyValueTracker) {
            ...
            localKeyValue.serialize(new javax.xml.namespace.QName(
                    "http://www.w3.org/2000/09/xmldsig#", "KeyValue"), xmlWriter);
        }

        if (localRetrievalMethodTracker) {
            if (localRetrievalMethod == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "RetrievalMethod cannot be null!!");
            }

            localRetrievalMethod.serialize(new javax.xml.namespace.QName(
        ...
        if (localX509DataTracker) {
            if (localX509Data == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "X509Data cannot be null!!");
            }

            localX509Data.serialize(new javax.xml.namespace.QName(
                    "http://www.w3.org/2000/09/xmldsig#", "X509Data"), xmlWriter);
        }

        if (localPGPDataTracker) {
            if (localPGPData == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "PGPData cannot be null!!");
            }

            localPGPData.serialize(new javax.xml.namespace.QName(
                    "http://www.w3.org/2000/09/xmldsig#", "PGPData"), xmlWriter);
        }

        if (localSPKIDataTracker) {
            if (localSPKIData == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "SPKIData cannot be null!!");
            }

            localSPKIData.serialize(new javax.xml.namespace.QName(
                    "http://www.w3.org/2000/09/xmldsig#", "SPKIData"), xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static KeyInfoTypeChoice parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            KeyInfoTypeChoice object = new KeyInfoTypeChoice();
            ...
            try {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.w3.org/2000/09/xmldsig#", "KeyName").equals(
                            reader.getName())) {
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "KeyName" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setKeyName(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                 ...
                 if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.w3.org/2000/09/xmldsig#", "KeyValue").equals(
                            reader.getName())) {
                    object.setKeyValue(org.w3.www._2000._09.xmldsig.KeyValueType.Factory.parse(
                            reader));
                 ...
                 if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.w3.org/2000/09/xmldsig#",
                            "RetrievalMethod").equals(reader.getName())) {
                    object.setRetrievalMethod(org.w3.www._2000._09.xmldsig.RetrievalMethodType.Factory.parse(
                            reader));
                 ...
                 if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.w3.org/2000/09/xmldsig#", "X509Data").equals(
                            reader.getName())) {
                    object.setX509Data(org.w3.www._2000._09.xmldsig.X509DataType.Factory.parse(
                            reader));
                 ...
                 if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.w3.org/2000/09/xmldsig#", "PGPData").equals(
                            reader.getName())) {
                    object.setPGPData(org.w3.www._2000._09.xmldsig.PGPDataType.Factory.parse(
                            reader));
                 ...
                 if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.w3.org/2000/09/xmldsig#", "SPKIData").equals(
                            reader.getName())) {
                    object.setSPKIData(org.w3.www._2000._09.xmldsig.SPKIDataType.Factory.parse(
                            reader));
                 ...
                 if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.w3.org/2000/09/xmldsig#", "MgmtData").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "MgmtData" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setMgmtData(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
