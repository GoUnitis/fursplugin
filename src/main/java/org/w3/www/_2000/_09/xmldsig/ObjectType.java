...
public class ObjectType implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected void validateObjectTypeSequence(
        org.w3.www._2000._09.xmldsig.ObjectTypeSequence[] param) {
    }
     ...
     */
    public void setObjectTypeSequence(
        org.w3.www._2000._09.xmldsig.ObjectTypeSequence[] param) {
     ...
     */
    public void addObjectTypeSequence(
        org.w3.www._2000._09.xmldsig.ObjectTypeSequence param) {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localObjectTypeSequence);
        list.add(param);
        this.localObjectTypeSequence = (org.w3.www._2000._09.xmldsig.ObjectTypeSequence[]) list.toArray(new org.w3.www._2000._09.xmldsig.ObjectTypeSequence[list.size()]);
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ObjectType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ObjectType", xmlWriter);
            }
        }
        ...
        if (localMimeType != null) {
            writeAttribute("", "MimeType",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localMimeType), xmlWriter);
        }

        if (localEncoding != null) {
            writeAttribute("", "Encoding",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localEncoding), xmlWriter);
        }
        ...
        if (localObjectTypeSequenceTracker) {
            if (localObjectTypeSequence != null) {
                ...
                throw new org.apache.axis2.databinding.ADBException(
                    "ObjectTypeSequence cannot be null!!");
            }
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        attribList.add(new javax.xml.namespace.QName("", "MimeType"));
    ...
    public static class Factory {
         ...
         */
        public static ObjectType parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObjectType".equals(type)) {
                            ...
                            return (ObjectType) si.gov.fu.www.v1.cash_registers.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribMimeType = reader.getAttributeValue(null,
                        "MimeType");

                if (tempAttribMimeType != null) {
                    java.lang.String content = tempAttribMimeType;

                    object.setMimeType(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            tempAttribMimeType));
                } else {
                }
                ...
                java.lang.String tempAttribEncoding = reader.getAttributeValue(null,
                        "Encoding");

                if (tempAttribEncoding != null) {
                    java.lang.String content = tempAttribEncoding;

                    object.setEncoding(org.apache.axis2.databinding.utils.ConverterUtil.convertToAnyURI(
                            tempAttribEncoding));
                } else {
                }
                ...
                try {
                    if (reader.isStartElement()) {
                        ...
                        list1.add(org.w3.www._2000._09.xmldsig.ObjectTypeSequence.Factory.parse(
                                reader));
                        ...
                        object.setObjectTypeSequence((org.w3.www._2000._09.xmldsig.ObjectTypeSequence[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
