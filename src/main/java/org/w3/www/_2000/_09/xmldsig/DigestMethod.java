...
public class DigestMethod implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
         ...
         */
        public static DigestMethod parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DigestMethod object = new DigestMethod();
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    ...
                                    "DigestMethod").equals(reader.getName())) {
