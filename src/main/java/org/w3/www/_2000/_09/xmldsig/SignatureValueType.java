...
public class SignatureValueType implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":SignatureValueType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "SignatureValueType", xmlWriter);
            }
        }
    ...
    public static class Factory {
        ...
        public static SignatureValueType fromString(
         ...
         */
        public static SignatureValueType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SignatureValueType object = new SignatureValueType();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SignatureValueType".equals(type)) {
                            ...
                            return (SignatureValueType) si.gov.fu.www.v1.cash_registers.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
