...
/**
 *  City_type0 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class City_type0 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":City_type0", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "City_type0", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static City_type0 parse(javax.xml.stream.XMLStreamReader reader)
