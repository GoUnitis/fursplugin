...
/**
 *  City_type1 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class City_type1 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":City_type1", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "City_type1", xmlWriter);
            }
        }
    ...
    public static class Factory {
        public static City_type1 fromString(java.lang.String value,
            ...
            returnValue.setCity_type0(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    value));
         ...
         */
        public static City_type1 parse(javax.xml.stream.XMLStreamReader reader)
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement() || reader.hasText()) {
                        if (reader.isStartElement() || reader.hasText()) {
                            ...
                            object.setCity_type0(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));
